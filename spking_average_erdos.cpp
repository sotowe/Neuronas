    ...
    for (J = 5; J <= 21; J=J+5)
    {
        for (conditions = 1; conditions <=2; conditions ++)
        {
            ...
            if (J == 5)
            {
                 if (conditions == 1)
                {
                    file1.open("archivostxt/meanaverageV_J5_ro0_Vo-3_con10.txt");
                    file2.open("archivostxt/meanrate_J5_ro0_Vo-3_con10.txt");
                }
                else if (conditions == 2)
                {
                    file1.open("archivostxt/meanaverageV_J5_ro1_Vo0_con10.txt");
                    file2.open("archivostxt/meanrate_J5_ro1_Vo0_con10.txt");
                }
            }
            else if (J == 10)
            {
                if (conditions == 1)
                {
                    file1.open("archivostxt/meanaverageV_J10_ro0_Vo-3_con10.txt");
                    file2.open("archivostxt/meanrate_J10_ro0_Vo-3_con10.txt");
                }
                else if (conditions == 2)
                {
                    file1.open("archivostxt/meanaverageV_J10_ro1_Vo0_con10.txt");
            ...
            else if (J == 15)
            {
                 if (conditions == 1)
                {
                    file1.open("archivostxt/meanaverageV_J15_ro0_Vo-3_con10.txt");
                    file2.open("archivostxt/meanrate_J15_ro0_Vo-3_con10.txt");
                }
                else if (conditions == 2)
                {
                    file1.open("archivostxt/meanaverageV_J15_ro1_Vo0_con10.txt");
                    file2.open("archivostxt/meanrate_J15_ro1_Vo0_con10.txt");
                }
            }
            else if (J == 20)
            {
                 if (conditions == 1)
                {
                    file1.open("archivostxt/meanaverageV_J20_ro0_Vo-3_con10.txt");
                    file2.open("archivostxt/meanrate_J20_ro0_Vo-3_con10.txt");
                }
                else if (conditions == 2)
                {
                    file1.open("archivostxt/meanaverageV_J20_ro1_Vo0_con10.txt");
